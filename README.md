...
Hangman game project created as a submission to Week 5: Python Fundamentals for the Rockborne data analytics training course.

The game follows the basic rules of hangman, where a player tries to guess a word by guessing individual letters. Too many wrong guesses and the player loses.
